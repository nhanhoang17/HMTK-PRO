...
class Config:
    ...
    BATCH_SIZE  = 128    # paper: mini-batch = 64
    EPOCHS_CFLS = 100    # paper: epochs = 10
    PATIENCE    = 10     # paper: early stopping patience = 3
    ...
    # CHIA THEO USER-LEVEL: 70% Train, 10% Val, 20% Test
    USER_SPLIT_RATIO = [0.7, 0.1, 0.2] 
    
    COLD_START_RATIO = 0.7  # Ty le Cold-start chi tinh rieng trong nhom Test Users
    TOP_K            = [20, 40, 60, 80]
